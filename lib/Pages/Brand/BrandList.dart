...
class _GetBrandsState extends State<GetBrands> {
  ...
  //Get brands in FirebaseFirestore
                  ...
                  onTap: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => UpdateBrand(
                              ...
                              image: document["brandImage"],
                              address: document["brandAddress"],
                              phoneNumber: document["brandPhoneNumber"],
                            )));
                  },
        ...
        builder: (context, snapshot) {
          if (!snapshot.hasData) {
            ...
            final results = snapshot.data.docs.where((DocumentSnapshot a) =>
                a['brandName'].toString().contains(query));
            return ListView(
                children: results
                          ...
                          child: InkWell(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (context) => UpdateBrand(
                                        id: a.data["brandID"],
                                        name: a.data["brandName"],
                                        image: a.data["brandImage"],
                                        address: a.data["brandAddress"],
                                        phoneNumber: a.data["brandPhoneNumber"],
                                      )));
                            },
                            child: ListTile(
                              leading: Image.network(
