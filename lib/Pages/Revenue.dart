...
class _RevenueDashBoardState extends State<RevenueDashBoard> {
              ...
              child: Column(
                ...
                children: <Widget>[
                                ...
                                onTap: () {
                                  DatePicker.showDatePicker(context,
                                    ...
                                    _toTimeControl.text =
                                        DateFormat("yyyy-MM-dd").format(date);
                                    var compare =
                                        _toTimeControl.text.compareTo(title);
                                    if (compare == -1) {
                                      setState(() {
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              ...
                              FirebaseFirestore.instance
                                  .collection("orders")
                                  .where("time", isGreaterThanOrEqualTo: t3)
                                  .where("time", isLessThanOrEqualTo: t4)
                                  .get()
                                  .then((snapshot) => {
                  ...
                  orders.isEmpty
                      ? ListView(
                          shrinkWrap: true,
                          children: <Widget>[_showRecordDateRange(orders)],
                        )
                      : Column(
                          children: <Widget>[
                            Padding(
                              ...
                              child: Text(
                                  "Num of Orders with date range: ${orders.length.toString()}",
                                  style: TextStyle(
                                      fontWeight: FontWeight.bold,
                                      color: Colors.black,
                                      fontSize: 16)),
                            ...
                            Padding(
                              padding: const EdgeInsets.all(10.0),
                              child: Text(
                                  "Total cost of orders: ${_totalCost(orders)}",
                                  style: TextStyle(
                                      fontWeight: FontWeight.bold,
                                      color: Colors.black,
                                      fontSize: 18)),
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      children: <Widget>[
                        ...
                        Text(
                          document["informationPersonal"]["name"],
                          style: TextStyle(
                              fontSize: 16,
                              fontWeight: FontWeight.w400,
                              color: Colors.black),
  ...
  _totalCost(List<DocumentSnapshot> listTotal) {
    ...
    listTotal.map((DocumentSnapshot document) {
      ProductR.fromSnapshot(document)
          .products
          .map((product) => totalCost += product["cost"])
          .toList();
    }).toList();
